		<footer id="footer">
			<div class="container-fluid colorfooter">
				<div class="row blockfooter">
					<div class="col-lg-4 col-md-4 col-sm-12">
						<h4 class="titrefooter">Nous Joindre:</h4>
						<p class="textefooter">Du lundi au vendredi <br>
							de 9h à 12h30 et de 13h à 17h</p>
						<p class="textefooter">Tél: 03 84 85 12 34</p>

					</div>
					<div class="col-lg-4 col-md-4 col-sm-12">
						<h4 class="titrefooter">Nos Locaux:</h4>
						<p class="textefooter">2 Route de Montaigu<br>
							39400 Lons-le-Saunier</p>
					</div>
					<div class="col-lg-4">
				...
				<div class="row">
					<div class="col-6 mt-5 mb-2">
						<div class="basfoot">DebugDumpPromo</div>
					</div>
					<div class="col-6 mt-5 d-flex justify-content-end mb-2">
						<div class="basfoot">Mentions légales</div>
					</div>
				</div>
			</div>
		</footer>
